 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 * |Ctrl/Grv|  '"  |AltShf| Left | Right|                                       |  Up  | Down | Alt/[|   ]  | ~L1  |
 * `------------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox(
  ...
  CTL_T(KC_GRV),   KC_QUOT,     LALT(KC_LSFT), KC_LEFT, KC_RGHT,
...
[CMDS] = LAYOUT_ergodox(
  ...
  LCTL(LSFT(KC_Z)), LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_TRNS, KC_TRNS,
